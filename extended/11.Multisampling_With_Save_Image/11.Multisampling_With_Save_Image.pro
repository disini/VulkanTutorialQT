...
HEADERS += \
     source/3rdparty/tinyobj/tiny_obj_loader_me.h \
     source/3rdparty/stb_image/stb_image.h \
     source/3rdparty/utils/util_init.hpp \
     source/3rdparty/utils/util.hpp

SOURCES += \
     source/main.cpp \
     source/3rdparty/utils/util_init.cpp \
     source/3rdparty/utils/util.cpp
...
#               /media/liusheng/Programfiles/Programs/VulkanSDK/1.2.148.1/ubuntu/samples/API-Samples \
#               /media/liusheng/Programfiles/Programs/VulkanSDK/1.2.148.1/ubuntu/samples/API-Samples/utils \
#               /media/liusheng/Programfiles/Programs/libs/stb_image \
#	       source
INCLUDEPATH+= source/3rdparty \
               source/3rdparty/stb_image \
               source/3rdparty/tinyobj
#               source/3rdparty/glm
#	       source/3rdparty/utils
...
CONFIG(debug, debug|release){
    TARGET = 11.Multisampling_With_Save_Image
